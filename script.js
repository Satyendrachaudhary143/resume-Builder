 ...
 let conent= `   <div class="pritable">
            ...
            <div class="education">
                ...
                <ul>
                  ...
                  <li>${education2.value}</li>
                  <li>${education3.value}</li>
                  <li>${education4.value}</li>
                    <li>${education5.value}</li>
                </ul>
        </div>
            <div class="skills">
                <h2>SKILLS</h2>
            ...
            <div class="workExperience">
                ...
                <ul>
                    ...
                    <li>${experience2.value}</li>
                    <li>${experience3.value}</li>
                    <li>${experience4.value}</li>
                    <li>${experience5.value}</li>
                </ul>
